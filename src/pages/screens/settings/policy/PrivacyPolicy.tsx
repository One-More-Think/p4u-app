...
const PrivacyPolicyScreen = ({ route, navigation }: any) => {
    ...
    <SettingCommonHeader title={title} navigation={navigation}>
      ...
      >
        <Text style={{ color: isDarkMode ? 'white' : 'dark' }}>
          ...
          {'\n'}
          These terms and conditions apply to the P4U app (hereby referred to as
          "Application") for mobile devices that was created by Younghoon Yu
          ...
          Application is as beneficial and efficient as possible. As such, they
          reserve the right to modify the Application or charge for their
          services at any time and for any reason. The Service Provider assures
          you that any charges for the Application or its services will be
          ...
          correctly or at all.{'\n'}
          {'\n'}
          <Text style={{ fontWeight: 'bold' }}>Location-Based Information</Text>
          {'\n'}
          ...
          Wi-Fi, or mobile networks. The Service Provider ensures that such data
          is handled in compliance with privacy regulations and is not shared
          with unauthorized third parties. Users can disable location services
          in their device settings if they do not wish to share location data.
          {'\n'}
          {'\n'}
          ...
          usage. The Application does not knowingly collect personal information
          from children under the age of 13 without parental consent. If a
          parent or guardian discovers that their child has provided personal
          data without consent, they should contact the Service Provider
          immediately to remove the information. The Service Provider reserves
          the right to restrict access to certain features to ensure the safety
          of young users. Please note that the Application utilizes third-party
          ...
          you use the application outside of your home territory (i.e., region
          or country) without disabling data roaming. If you are not the bill
          payer for the device on which you are using the application, they
          assume that you have obtained permission from the bill payer.{'\n'}
          {'\n'}Similarly, the Service Provider cannot always assume
          responsibility for your usage of the application. For instance, it is
          ...
          of the application, it is important to note that while they strive to
          ...
          application when offered to you. The Service Provider may also wish to
          cease providing the application and may terminate its use at any time
          without providing termination notice to you. Unless they inform you
          otherwise, upon any termination, (a) the rights and licenses granted
          to you in these terms will end; (b) you must cease using the
